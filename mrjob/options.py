    ...
    def __call__(self, parser, namespace, value, option_string=None):
        ...
        for choice in value.split(','):
            if choice in CLEANUP_CHOICES:
                ...
                parser.error(
                    f"{option_string} got {choice}, which is not one of: {', '.join(CLEANUP_CHOICES)}"
                )


        if 'NONE' in result and len(set(result)) > 1:
            parser.error(f'{option_string}: Cannot clean up both nothing and something!')
...
class _AppendJSONAction(Action):
    ...
    def __call__(self, parser, namespace, value, option_string=None):
        ...
        try:
            ...
            parser.error(f'Malformed JSON passed to {option_string}: {str(e)}')
...
_STEP_OPTS = dict(
    ...
    run_mapper=(
        ['--mapper'],
        dict(action='store_true', help='run a mapper'),
    ),
    run_reducer=(
        ['--reducer'],
        dict(
...
_RUNNER_OPTS = dict(
        ...
        switches=[
            (
                ...
                dict(
                    ...
                    help=(
                        'Additional applications to run on 4.x and 5.x'
        ...
        switches=[
            (
                ...
                dict(
                    action='store_true',
                    help=(
                        'Attempt to install a compatible version of Python'
            ...
            (
                ...
                dict(
                    action='store_false',
                    help=(
                        "Don't automatically try to install a compatible version"
        ...
        switches=[
            (
                ...
                dict(
                    ...
                    help=f"Comma-separated list of which directories to delete when a job succeeds, e.g. TMP,LOGS. Choices: {', '.join(CLEANUP_CHOICES)} (default: ALL)",
                ),
            )
        ]
    ),
    cleanup_on_failure=dict(
        switches=[
            (
                ...
                dict(
                    action=_CleanupAction,
                    help=f"Comma-separated list of which directories to delete when a job fails, e.g. TMP,LOGS. Choices: {', '.join(CLEANUP_CHOICES)} (default: NONE)",
                ),
            )
        ]
    ),
        ...
        switches=[
            (
                ...
                dict(
                    ...
                    help=(
                        'Properties to set in Hadoop config files on Dataproc.'
        ...
        switches=[
            (
                ...
                dict(
                    action=_KeyValueAction,
                    help=(
                        'Set an environment variable for your job inside Hadoop '
        ...
        switches=[
            (
                ...
                dict(
                    action=_JSONAction,
                    help=(
                        'detailed JSON dict of configs for the core'
                        ' (worker) instances'
        ...
        switches=[
            (
                ...
                dict(
                    action='append',
                    help=(
                        'Volume to mount into docker, e.g. '
    ...
    ebs_root_volume_gb=dict(
        ...
        switches=[
            (
                ...
                dict(
                    help=(
                        'Size of root EBS volume, in GiB. Must be an integer.'
    ...
    ec2_endpoint=dict(
        ...
        switches=[
            (
                ...
                dict(
                    help=(
                        'Force mrjob to connect to EC2 on this endpoint'
    ...
    emr_endpoint=dict(
        ...
        switches=[
            (
                ...
                dict(
                    help=(
                        'Force mrjob to connect to EMR on this endpoint'
        ...
        switches=[
            (
                ...
                dict(
                    action='store_true',
                    help=(
                        "In the first mapper, set $mapreduce_map_input_file to"
        ...
        switches=[
            (
                ...
                dict(
                    ...
                    help=(
                        'extra parameter to pass to cloud API when creating'
        ...
        switches=[
            (
                ...
                dict(
                    ...
                    help=(
                        'One or more arguments to pass to the hadoop binary.'
        ...
        switches=[
            (
                ...
                dict(
                    action='append',
                    help=(
                        'Directory to search for hadoop logs in. You can use'
    ...
    hadoop_streaming_jar=dict(
        ...
        switches=[
            (
                ...
                dict(
                    help=(
                        'Path of your hadoop streaming jar (locally, or on'
    ...
    iam_endpoint=dict(
        ...
        switches=[
            (
                ...
                dict(
                    help=(
                        'Force mrjob to connect to IAM on this endpoint'
        ...
        switches=[
            (
                ...
                dict(
                    action=_JSONAction,
                    help=(
                        'detailed JSON list of instance fleets, including'
    ...
    instance_type=dict(
        ...
        switches=[
            (
                ...
                dict(
                    help=(
                        'Type of GCE/EC2 instance(s) to launch \n'
        ...
        switches=[
            (
                ...
                dict(
                    action=_KeyValueAction,
                    help=(
                        'passed through to hadoop streaming as -D and to Spark'
        ...
        switches=[
            (
                ...
                dict(
                    action=_AppendCommaSeparatedItemsAction,
                    help=(
                        'Paths of JARs to pass to Hadoop with -libjars,'
    ...
    master_instance_bid_price=dict(
        ...
        switches=[
            (
                ...
                dict(
                    help=(
                        'Bid price to specify for the master node when'
        ...
        switches=[
            (
                ...
                dict(
                    action=_JSONAction,
                    help=(
                        'detailed JSON dict of configs for the master instance'
                        ' on Dataproc including disk config. For format, see'
                        ' https://cloud.google.com/dataproc/docs/reference/rest'
                        '/v1/projects.regions.clusters#InstanceGroupConfig'
                        ' (except that fields in your JSON should use'
    ...
    max_clusters_in_pool=dict(
        switches=[
            (
                ...
                dict(
                    help=(
                        "If attempting to join a pooled cluster, don't bail"
    ...
    max_concurrent_steps=dict(
        ...
        switches=[
            (
                ...
                dict(
                    help=(
                        "Maximum number of steps that may run on the cluster"
    ...
    max_output_files=dict(
        switches=[
            (
                ...
                dict(
                    help=(
                        'Maximum number of output files when running a'
    ...
    min_available_mb=dict(
        switches=[
            (
                ...
                dict(
                    help=(
                        'When attempting to join a pooled cluster, check'
    ...
    network=dict(
        ...
        switches=[
            (
                ...
                dict(
                    help=(
                        'URI of Google Compute Engine network to launch cluster'
        ...
        switches=[
            (
                ...
                dict(
                    action='store_true',
                    help=(
                        'Add to an existing cluster or create a new one that'
    ...
    pool_jitter_seconds=dict(
        switches=[
            (
                ...
                dict(
                    help=(
                        'If --max-pools-in-cluster is set, before launching a'
    ...
    pool_timeout_minutes=dict(
        switches=[
            (
                ...
                dict(
                    help=(
                        "If pooling can't join or create a cluster within this"
    ...
    pool_wait_minutes=dict(
        switches=[
            (
                ...
                dict(
                    help=(
                        'Wait for a number of minutes for a cluster to finish'
        ...
        switches=[
            (
                ...
                dict(
                    ...
                    help=(
                        'Project to use when connecting to Google Cloud Services'
        ...
        switches=[
            (
                ...
                dict(
                    action=_AppendCommaSeparatedItemsAction,
                    help=(
                        '.zip or .egg files to add to PYTHONPATH,'
                        ' separated by commas'
                    ),
                ),
            ),
    ...
    python_bin=dict(
        ...
        switches=[
            (
                ...
                dict(
                    help=(
                        'Alternate python command. You can include arguments,'
        ...
        switches=[
            (
                ...
                dict(
                    action='store_true',
                    help=(
                        'Parse logs generated by the job to get counters and'
    ...
    release_label=dict(
        ...
        switches=[
            (
                ...
                dict(
                    help=(
                        'Release Label (e.g. "emr-4.0.0"). Overrides'
                        ' --image-version'
                    ),
                ),
            ),
    ...
    service_account=dict(
        ...
        switches=[
            (
                ...
                dict(
                    help=(
                        'Service account to use when creating a Dataproc'
        ...
        switches=[
            (
                ...
                dict(
                    ...
                    help=(
                        "A comma-separated list of service account scopes"
        ...
        switches=[
            (
                ...
                dict(
                    action='append',
                    help=(
                        'A command to run before each mapper/reducer step in the'
    ...
    sh_bin=dict(
        ...
        switches=[
            (
                ...
                dict(
                    help=(
                        'Alternate shell command for setup scripts. You may'
        ...
        switches=[
            (
                ...
                dict(
                    action='store_true',
                    help=(
                        "Don't use the job's internal protocol to communicate"
    ...
    sort_bin=dict(
        ...
        switches=[
            (
                ...
                dict(
                    help=(
                        'Alternate shell command for the external sort binary.'
        ...
        switches=[
            (
                ...
                dict(
                    action=_AppendArgsAction,
                    help=(
                        'One or more arguments to pass to spark-submit'
    ...
    spark_deploy_mode=dict(
        switches=[
            (
                ...
                dict(
                    help=(
                        '--deploy-mode argument to spark-submit (e.g.'
    ...
    spark_master=dict(
        switches=[
            (
                ...
                dict(
                    help=(
                        '--master argument to spark-submit (e.g. '
    ...
    spark_submit_bin=dict(
        ...
        switches=[
            (
                ['--spark-submit-bin'],
                dict(help='spark-submit binary. You may include arguments.'),
            ),
        ],
    ),
    spark_tmp_dir=dict(
        ...
        switches=[
            (
                ...
                dict(
                    help=(
                        'optional URI visible to Spark executors to use as our'
                        ' temp directory.'
                    ),
                ),
            ),
    ...
    ssh_add_bin=dict(
        ...
        switches=[
            (
                ...
                dict(
                    help=(
                        "Name/path of ssh-add binary. Arguments are allowed"
    ...
    ssh_bin=dict(
        ...
        switches=[
            (
                ...
                dict(
                    help=(
                        "Name/path of ssh binary. Arguments are allowed (e.g."
                        " --ssh-bin 'ssh -v')"
                    ),
                ),
            ),
        ...
        switches=[
            (
                ...
                dict(
                    ...
                    help=(
                        'A list of port ranges that are safe to listen on,'
        ...
        switches=[
            (
                ...
                dict(
                    action='store_true',
                    help=(
                        'Open an SSH tunnel to the Hadoop job tracker/resource'
                        ' manager'
                    ),
                ),
            ),
            (
                ...
                dict(
                    action='store_false',
                    help=(
                        "Don't open an SSH tunnel to the Hadoop job"
        ...
        switches=[
            (
                ...
                dict(
                    action='store_true',
                    help=(
                        'Make ssh tunnel accessible from remote hosts (not just'
                        ' localhost)'
                    ),
                ),
            ),
            (
                ...
                dict(
                    action='store_false',
                    help=(
                        'Make ssh tunnel accessible from localhost only (the'
                        ' default)'
                    ),
                ),
            ),
    ...
    subnet=dict(
        ...
        switches=[
            (
                ...
                dict(
                    help=(
                        'ID of Amazon VPC subnet/URI of Google Compute Engine'
            ...
            (
                ...
                dict(
                    action=_CommaSeparatedListAction,
                    help=(
                        'Like --subnet, but with a comma-separated list, to'
        ...
        switches=[
            (
                ...
                dict(
                    action=_KeyValueAction,
                    help=(
                        'Metadata tags to apply to the EMR cluster; '
        ...
        switches=[
            (
                ...
                dict(
                    action=_JSONAction,
                    help=(
                        'detailed JSON dict of configs for the task'
    ...
    task_python_bin=dict(
        ...
        switches=[
            (
                ...
                dict(
                    help=(
                        'Name/path of alternate python command to use to'
        ...
        switches=[
            (
                ...
                dict(
                    action=_AppendCommaSeparatedItemsAction,
                    help=(
                        'Archives to unpack in the working directory of the'
        ...
        switches=[
            (
                ...
                dict(
                    action=_AppendCommaSeparatedItemsAction,
                    help=(
                        'Directories to tarball and unpack in the working'
        ...
        switches=[
            (
                ...
                dict(
                    action=_AppendCommaSeparatedItemsAction,
                    help=(
                        'Files to copy to the working directory of the script,'
    ...
    zone=dict(
        ...
        switches=[
            (
                ...
                dict(
                    help=(
                        'GCE zone/AWS availability zone to run Dataproc/EMR jobs'
                        ' in.'
                    ),
                ),
            ),
...
def _add_runner_args_for_opt(parser, opt_name, include_deprecated=True,
    ...
    for args, kwargs in switches:
        ...
        if (include_deprecated or not deprecated) and not suppressed(args):
            ...
            kwargs['default'] = [] if kwargs.get('action') == 'append' else None
        ...
        if (deprecated_aliases and include_deprecated and
            ...
            help = f"Deprecated alias{'es' if len(deprecated_aliases) > 1 else ''} for {args[-1]}"
